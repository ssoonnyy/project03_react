      ...
      <>
        <div className="total_price">
          ...
          <p className='total_price'>총금액 <span>
            {
              (hots[id].price * count).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
            }
          <span style={{fontSize : 14}}> 원</span></span></p>
        </div>
      </>
    )
  }
          ...
          <div className="product_info">
            <div className="detail_info">
              ...
              <p className="product_price">판매가
                <span>{(hots[id].price).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}<span style={{fontSize : 14}}> 원</span></span>
              </p>
              ...
              <p className="product_made">생산국<span>{hots[id].made}</span></p>
              <p className="product_madeby">제조사<span>{hots[id].madeby}</span></p>
            </div>
